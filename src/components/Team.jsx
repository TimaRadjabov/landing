...
const TEAM = [
  {
    avatar: kirillImg,
    name: 'Кирилл, мастер',
    role: '5 лет стажа · Мастер комплексного ремонта',
    desc: 'Инженерное образование. Окончил «Бригадный подряд». Специализация — ремонт под ключ. Управлял 11 объектами одновременно.',
  },
  {
    avatar: farxatImg,
    name: 'Фархат, мастер',
    role: '5 лет стажа · Мастер плиточных работ',
    desc: 'Инженерное образование. Специализация — санузлы под ключ. Гарантирую точный расчёт, геометрию и долговечность результата.',
  },
];
